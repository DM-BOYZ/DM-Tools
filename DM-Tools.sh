...
echo -b "TOTALS    : DM TOOLS " | lolcat
echo -b "AUTHOR    : DM $green " |lolcat
echo -b "ASSOCIATE : INDONESIAN TERMUX ASSOCIATE $green " |lolcat
echo -b "ASSOCIATE : DM-BOYZ $green " |lolcat
echo -b "ASSOCIATE : THIS TOOL ISN'T MINE,I JUST MODIFY IT $green " |lolcat
...
00) echo "AUTHOR: DD-BOYZ" | lolcat
echo "FUCK SYSTEM" | lolcat
echo "INDONESIAN TERMUX ASSOCIATION" | lolcat
echo "DM-BOYZ ISN'T THE OWNER OF THIS TOOL,THEY JUST MODIFY IT" | lolcat
figlet DM-TOOLS | lolcat
exit
;;

*) echo "Sorry, Your choices it's not already [DM]"
esac
done
done
